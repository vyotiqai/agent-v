...
| **Your AI** | This month's spend of the limit; the provider, key's last 4 characters, status; models for jobs and quick steps; other providers; *web search: the Brave Search key ([D161](../build/slice-02-your-ai.md#decisions-made-in-this-slice))* | Key declined: status reads "Declined" and opens Key declined. Limit reached: the numbers read "Limit reached". Testing a replaced key: progress on the button. *No key: "Connect your AI · No AI connected" in place of the provider and models ([D162](../build/slice-02-your-ai.md#decisions-made-in-this-slice))* | Replace key: Paste and test key. Change limit: amounts. *Remove: asks ("Remove your Anthropic key? It's deleted at once. Jobs wait until a key works."), then the key is deleted and the bar says so, with no Undo ([D162](../build/slice-02-your-ai.md#decisions-made-in-this-slice))*. A model: Choose models. Add another provider. *Brave Search key: its page ([D161](../build/slice-02-your-ai.md#decisions-made-in-this-slice))* |
| **Brave Search key** *(added by [D161](../build/slice-02-your-ai.md#decisions-made-in-this-slice))* | What it's for (searching the web when the AI provider can't; Anthropic, OpenAI and Google search for themselves); three steps to get one; the key field; how it's kept | Testing: progress on Test and save. Declined: "Brave says this key isn't valid". Can't reach Brave: "Couldn't reach Brave · Try again". Saved: back on Your AI, the row reads the key's last 4 characters | Open Brave: Brave's API site in the phone's browser. Test and save. Back |
...
| **Privacy and your data** | Export everything; what I remember; files on my computer; how your data is kept; your phones *(added by [D137](../build/slice-01-accounts.md#decisions-made-in-this-slice))*: each phone signed in, "This phone" marked, the others with when they were last used; sign out; delete my account | Export being prepared: "Preparing… I'll tell you when it's ready" *(changed by D111, stage 6: no email)* | Export: asks once, then a notification when it's ready; the download opens in the app and stays for 7 days (J10, D111). Sign out another phone: asks ("Sign out Pixel 6a? It will need to sign in again."), then it's gone from the list and the bar says so, with no Undo. Sign out: asks. Delete my account: the can't-be-undone page (J10) |
...
| Screen | Shows, and limits | States | Actions |
|---|---|---|---|
| **Welcome** | "Hand it off." and what it does in one sentence; Apple and Google (email removed by D100, stage 6); the terms line. *On Android until slice 13, Google alone, as the main button ([D144](../build/slice-01-accounts.md#decisions-made-in-this-slice))* | Sign-in cancelled: back here, nothing said. Failed: one line under the buttons, "Couldn't sign in with Google · Try again". *No screen lock on the phone: "Set a screen lock on this phone first. Agent V uses it when you sign for something." ([D145](../build/slice-01-accounts.md#decisions-made-in-this-slice))* | Continue with Apple or Google |
...
| **Connect your AI** | "Agent V is free…"; Anthropic, OpenAI, Google, another provider | — | Pick one. Get a key: Get a key. I have a key: Paste and test key. ~~Back~~ *Not now, top right: to You, where Your AI reads "Not connected" (D46, [D160](../build/slice-02-your-ai.md#decisions-made-in-this-slice)). From Add another provider: Back* |
